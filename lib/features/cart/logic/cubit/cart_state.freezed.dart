...
class Success implements CartState {
  const Success(final List<CartItemModel> items) : _items = items;
  ...
  @override
  String toString() {
    return 'CartState.success(items: $items)';
  }
}
...
class Error implements CartState {
...
/// @nodoc
abstract mixin class $ErrorCopyWith<$Res> implements $CartStateCopyWith<$Res> {
